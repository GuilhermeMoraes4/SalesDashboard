...
import pandas as pd
# Importar o tema do bootstrap e o switcher de temas
from app import *
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    ...
                    dbc.Row([
                        dbc.Button("Visite o Linkedin do Dev", href="https://www.linkedin.com/in/guilherme-moraes040500/", target="_blank")
                    ], style={'margin-top': '10px'})
                ])
            ], style=tab_card)
        ], sm=4, lg=2),
